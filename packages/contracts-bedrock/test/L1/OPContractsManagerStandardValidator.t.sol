...
contract OPContractsManagerStandardValidator_TestInit is CommonTest {
    ...
    // TODO: Investigate the best way to dedupe this util taken from OPContractsManager.t.sol
        ...
        returns (IOPContractsManager.AddGameOutput memory)
    {
        ...
        vm.prank(address(proxyAdmin), address(proxyAdmin));
        vm.expectEmit(true, true, true, false, address(this));
        emit GameTypeAdded(l2ChainId, input.disputeGameType, address(0), address(0));
